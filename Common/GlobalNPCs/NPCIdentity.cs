...
namespace Divergency.Common.GlobalNPCs
{
    public class NPCIdenity : GlobalNPC
    {
        ...
        public bool livingGroveFauna(NPC npc) => (npc.type == ModContent.NPCType<Coreling>() || npc.type == ModContent.NPCType<Corelossus>() ||  npc.type == ModContent.NPCType<CoreElemental>() || npc.type == ModContent.NPCType<Corennector>());
