...
namespace Divergency.Content.NPCs.LivingGrove
{
    ...
    public class Underseer : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
                ...
                Texture2D glow = ModContent.Request<Texture2D>("Divergency/Content/NPCs/LivingGrove/UnderseerGlow").Value;
                ...
                Main.EntitySpriteDraw(glow, NPC.Center - Main.screenPosition + new Vector2(0, 0), null, Color.White, NPC.rotation, drawOrigin, NPC.scale, SpriteEffects.None, 0);
