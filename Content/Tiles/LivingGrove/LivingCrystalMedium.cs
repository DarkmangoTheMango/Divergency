...
{
    public class LivingCrystalMedium1 : ModTile
    {
    ...
    public class LivingCrystalMedium2 : LivingCrystalMedium1
    {

    }

    public class LivingCrystalTestItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<LivingCrystalMedium1>();
            Item.placeStyle = 0;
    ...
    public class LivingCrystalTestItem2 : ModItem
    {
        public override string Texture => "Divergency/Assets/Textures/Star";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<LivingCrystalMedium2>();
            Item.placeStyle = 0;
