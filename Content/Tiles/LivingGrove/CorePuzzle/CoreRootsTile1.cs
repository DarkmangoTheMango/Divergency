...
namespace Divergency.Content.Tiles.LivingGrove.CorePuzzle
{
    public class CoreRootsTile1 : ModTile
    {
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreRootsTile1").Value;
    ...
    {
        public override string Texture => "Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreRootsTile1";
