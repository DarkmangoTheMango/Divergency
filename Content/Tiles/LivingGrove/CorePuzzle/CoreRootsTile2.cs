...
namespace Divergency.Content.Tiles.LivingGrove.CorePuzzle
{
    ...
    public class CoreRootsTile2 : ModTile
    {
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreRootsTile2").Value;
    ...
    {
        public override string Texture => "Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreRootsTile2";
