...
namespace Divergency.Content.Tiles.LivingGrove.CorePuzzle
{
    public class CoreResetTileDrop3 : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(120, 85, 60), Language.GetText("MapObject.Resetter"));
            DustType = 7;
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            ParticleManager.NewParticle(player.Center, player.velocity * 3, ParticleManager.NewInstance<LivingCoreInsertParticle>(), Color.LimeGreen, 1f);
            ParticleManager.NewParticle(player.Center, player.velocity * 3, ParticleManager.NewInstance<LivingCoreInsertParticle2>(), Color.LimeGreen, 1f);
            ParticleManager.NewParticle(player.Center, player.velocity * 3, ParticleManager.NewInstance<LivingCoreInsertParticle3>(), Color.LimeGreen, 1f);
            for (int x = 0; x < 1; x++)
            {
