...
namespace Divergency.Content.Tiles.LivingGrove.CorePuzzle
{
    public class CoreMirrorTileDown : ModTile
    {
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreMirrorTileDown").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    {
        public override string Texture => "Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreMirrorTileDown";
