...
namespace Divergency.Content.Tiles.LivingGrove.CorePuzzle
{
    public class CoreDoublerLeftUpTile : ModTile
    {
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreDoublerLeftUpTile").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    {
        public override string Texture => "Divergency/Content/Tiles/LivingGrove/CorePuzzle/CoreDoublerLeftUpTile";
