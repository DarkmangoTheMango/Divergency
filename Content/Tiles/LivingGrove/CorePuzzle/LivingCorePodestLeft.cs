...
namespace Divergency.Content.Tiles.LivingGrove.CorePuzzle
{
    ...
    {
        public override string Texture => "Divergency/Content/Tiles/LivingGrove/CorePuzzle/LivingCorePodestLeft";
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CorePuzzle/LivingCorePodestLeft").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CorePuzzle/LivingCorePodestLeftCharged").Value;
    ...
    {
        public override string Texture => "Divergency/Content/Tiles/LivingGrove/CorePuzzle/LivingCorePodestLeftCharged";
