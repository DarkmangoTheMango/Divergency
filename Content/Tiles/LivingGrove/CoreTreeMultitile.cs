...
namespace Divergency.Content.Tiles.LivingGrove
{
    ...
    {
        public const int FrameWidth = 16 * 18;
        public const int FrameHeight = 16 * 19;
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CoreTreeCrown").Value;
            Texture2D trunks = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CoreTreeTrunk").Value;

            Texture2D glow = ModContent.Request<Texture2D>("Divergency/Content/Tiles/LivingGrove/CoreTreeCrystals").Value;

            Vector2 offScreen = new Vector2(Main.offScreenRange);
            Vector2 globalPosition = p.ToWorldCoordinates(0f, 0f);
            Vector2 position = globalPosition + offScreen - Main.screenPosition - new Vector2(0,-15);
            Color color = Lighting.GetColor(i, j);
            Lighting.GetColor4Slice(i, j, ref colorsSliced);

            Main.EntitySpriteDraw(trunks, position, null, color, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
            Main.EntitySpriteDraw(texture, position, null, colorsSliced[3], 0f, Vector2.Zero, 1f, SpriteEffects.None, 0);
