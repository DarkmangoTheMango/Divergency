...
namespace Divergency.Content.Dusts
{
    class Sparkle : ModDust
    {
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(Divergency.Instance.Assets.Request<Effect>("Content/Effects/GlowingDust").Value), "GlowingDustPass");
