...
namespace Divergency.Content.Items.Weapons.Ranged
{
    public class BlueRose : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault($"Hold <left> to load the gun\nWhen loaded, shots will inflict Bullet Mark [i:{ModContent.ItemType<BulletMarkIcon>()}]");
        ...
        public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            for (int k = 0; k < 5; k++)
            {
                ...
                Dust dust = Dust.NewDustPerfect(position + offset, DustID.Torch, (perturbedSpeed * scale) * 0.5f, 0, default, 3f);
                dust.noGravity = true;
            }
