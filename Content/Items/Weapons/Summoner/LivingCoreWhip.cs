...
{
    public class LivingCoreWhip : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<LivingCoreWhipProj>(), 23, 2, 20, 30);
    ...
    public class LivingCoreWhipProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.WhipSettings.RangeMultiplier = 0.2f;
