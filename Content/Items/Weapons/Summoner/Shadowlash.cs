...
{
    public class Shadowlash : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.DefaultToWhip(ModContent.ProjectileType<ShadowlashPro>(), 23, 2, 4, 30);
    ...
    public class ShadowlashPro : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            if (Utils.GetLerpValue(0.1f, 0.7f, swingProgress, clamped: true) * Utils.GetLerpValue(0.9f, 0.7f, swingProgress, clamped: true) > 0.5f && !Main.rand.NextBool(3))
            {
                ...
                Dust dust = Dust.NewDustDirect(spawnArea.TopLeft(), spawnArea.Width, spawnArea.Height, dustType, 0f, 0f, 100, default, 1.5f);
        ...
        private void DrawLine(List<Vector2> list)
        {
            ...
            for (int i = 0; i < list.Count - 2; i++)
            {
                ...
                Color color = Lighting.GetColor(element.ToTileCoordinates(), new(182, 27, 248));
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int k = 0; k < list.Count - 1; k++)
            {
                ...
                Vector2 origin = new Vector2(7, 10);
                float scale = 1;
                ...
                Vector2 element = list[k];
                Vector2 diff = list[k + 1] - element;
